...
|------|------|----------|----------|----------|----------|----------|----------|------|
| SG | Traffic | 1 | 1 | 5,775,600 | 4,920,000 | 96.26% | 82.00% | ✓ 满足 |
| SG | Awareness | 2 | 2 | 224,400 | 1,080,000 | 3.74% | 18.00% | ✓ 满足 |
...
### SG
![SG 不同Stage下Media占比](mp_result_relaxation_trigger_achievement_check_stage_media_share_SG.png)
