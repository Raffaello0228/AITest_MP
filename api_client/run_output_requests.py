...
async def main(args):
    ...
    # brief-detail 配置
    brief_detail_tmpl = args.brief_detail or os.getenv(
        "BRIEF_DETAIL_URL_TEMPLATE",
        "https://pre-pu-gateway.meetsocial.com/sino-adtech-mediaplan/mediaPlan/brief/multi-country/{task_id}/brief-detail",
    )
    ...
    async with create_client_from_config(
        ...
        brief_detail_url_template=brief_detail_tmpl if brief_detail_tmpl else None,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="brief-detail URL 模板，需包含 {task_id} 占位符",
    )
    parser.add_argument(
