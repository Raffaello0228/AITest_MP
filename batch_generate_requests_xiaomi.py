...
def reorder_priorities(result: dict) -> dict:
    ...
    # regionBudget（新版本只包含 countryInfo，不包含 kpiInfo）
    # 无需排序
    ...
    for country in result.get("briefMultiConfig", []):
        ...
        # mediaMarketingFunnelFormat -> adFormatWithKPI.kpiInfo
...
if __name__ == "__main__":
    ...
    output_dir = "xiaomi_output/requests"
    country_path = "dict/xiaomi/country.csv"
    adformat_path = "dict/xiaomi/adformat.csv"
    test_case_id = None
    use_testcase_template = True
